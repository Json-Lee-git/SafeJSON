...
const steps = [
  ...
  },
  {
    ...
    steps: [
      ...
      "SafeJSON reduces this risk by keeping core JSON workflows browser-local and avoiding pasted-content upload for tool inputs.",
  ...
  },
  {
    ...
    id: "offline",
    steps: [
      "Once the page is loaded, SafeJSON core formatting and validation workflows can run without an internet connection.",
      "To test: load SafeJSON, then disconnect from the internet or use DevTools Offline mode. Paste JSON and format it.",
